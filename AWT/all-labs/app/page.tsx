      ...
      <div id="default-carousel" className="relative w-full" data-carousel="slide">
          <div className="relative h-56 overflow-hidden rounded-base md:h-96">
              <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <Image src="/1.jfif" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" width={100} height={100} alt="..."/>
              </div>
              <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <Image src="/2.png" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" width={100} height={100} alt="..."/>
              </div>
